...
void    main(int argc, char **argv)
{
  ...
  char *fname;
  real plotheight = PLOTHEIGHT;
  real plotwidth = PLOTWIDTH;
  /* indices for next line:0=theta0,1=theta1,2=tau */
  real from[3], to[3], by[3], needrange[3]; 
  real log10theta0, growth=0, tau, pval;
  /* for pictex output */
  int   thisfig, figrow, figcol, ntheta0, ntot;
  real  xpoint, ypoint;
  real  minx, maxx, minxtick, maxxtick, xtickvalue[25];
  real  miny, maxy, minytick, maxytick, ytickvalue[25];
